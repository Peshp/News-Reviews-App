    ...
    public partial class CreateTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "How much lifespan are you hoping to get out of a game? " },
                    { 2, "What do you prefer: Action or Logic? " },
                    { 3, "Which of these is most important to you in a game? " },
                    { 4, "Do you get easily bored with games? " },
                    { 5, "Are the music and sound options important? " },
                    { 6, "Which one of these games would you like to play? " },
                    { 7, "Next, depending on age and taste, is mature content a problem? " },
                    { 8, "How much of a gamer do you think you are? " },
                    { 9, "How many consoles do you have? " },
                    { 10, "Which of these films would you rather watch? " }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, 2, 2, "Mostly action, I guess." },
                    { 9, 3, 2, "I like logic, such as simple puzzles." },
                    { 10, 4, 2, "A good balance of both" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 45, 1, 9, "I have plenty of consoles. " },
                    ...
                    { 55, 5, 10, "The Butterfly Effect" },
                    { 56, 6, 10, "Lord Of The Rings" }
                });
